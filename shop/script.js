(function(window, document, $, undefined){
 ...
 $.ready(function(){
  ...
  window.onscroll = function(){
   var top = window.pageYOffset || document.documentElement.scrollTop, height = $.client.height(), pos = top+height/1.7;
  ...
  $(['#houseplan button']).on({click:function(e){
   this.onceClass('selected');
   this.parent().find(['img']).hide();
   this.parent().find('img[src*="'+this.data('img')+'"]').show();
  }});
 });
